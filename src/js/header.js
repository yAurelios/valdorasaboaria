function loadHeader() {
    ...
    // Check if the current page is cadastro.html
    const isRegistrationPage = currentPage.includes('cadastro.html');
    ...
    <header> 
        ...
        <nav class="navBox">
            <ul>
                ...
                ${!isRegistrationPage ? (!isLoggedIn ? '<li><a href="#" id="openPopup">Login</a></li>' : '<li><a href="#" id="logout">Sair</a></li>') : ''}
            </ul>
        </nav>
    </header>
    <div id="popup" class="popup" style="display: none;">
        <div class="popup-content">
            ...
            <form id="loginForm">
                ...
                <a href="#" id="submitLogin">Entrar</a><br>
                <div id="createAccountText">Não possuí conta? <a class="createAccount" href="../../src/html/cadastro.html">Crie aqui</a></div>
            </form>
        </div>
    </div>
